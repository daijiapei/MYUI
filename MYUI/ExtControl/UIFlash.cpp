...
//	{
//		LPCTSTR strFlashCLSID=_T("{D27CDB6E-AE6D-11CF-96B8-444553540000}");
...
//	}
//
//	CMuiString CFlashUI::g_strClassName = _T("FlashUI");
//
//	CMuiString CFlashUI::GetClassName() const
//	{
//		return CFlashUI::g_strClassName;
//	}
//
//	void CFlashUI::OnAttach(HWND hNewWnd)
//	{
//		return __super::OnAttach(hNewWnd);
//	}
//
//	void CFlashUI::OnDetach(HWND hOldWnd)
//	{
...
//		}
//
//		__super::ReleaseControl();
//	}
//
//	bool CFlashUI::CreateControl(const CLSID clsid)
//	{
//		if(true == __super::CreateControl(clsid))
//		{
