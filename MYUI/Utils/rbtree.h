...
typedef int(__stdcall* PFN_RBTREE_COMPARE)(const void* object1, const void* object2);
...
#define RBTREE_ENUM_AFT  0x04//后序
    //默认应返回0，不为 0 将会结束枚举
    typedef int(__stdcall* PFN_RBTREE_ENUM)(RBNODE* node, void* param);
